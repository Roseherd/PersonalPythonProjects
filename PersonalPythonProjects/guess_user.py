...
print("""In this guessing game the player has a secret number and the computer \
has to guess that secret number. 
Upper bound is the limit of the range from the number 1 of the range of values \
...
def computer_guess(x):
    ...
    print(f"Computer guessed the number {guess} correctly after {guess_count} tries. :)")
